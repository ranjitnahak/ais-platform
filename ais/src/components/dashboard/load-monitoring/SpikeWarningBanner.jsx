export default function SpikeWarningBanner({ spikeWarning }) {
  ...
  return (
    <div data-pdf-spike-banner className="flex items-start gap-3 rounded-2xl border border-[color-mix(in_srgb,var(--color-primary-container)_30%,transparent)] bg-[color-mix(in_srgb,var(--color-primary-container)_18%,var(--color-surface-container))] px-4 py-3">
      <span className="material-symbols-outlined shrink-0 text-[var(--color-primary-container)]" style={{ fontVariationSettings: "'FILL' 1" }}>
        warning
      </span>
      <p data-pdf-spike-banner-text className="text-sm font-bold text-[var(--color-on-surface)]">
