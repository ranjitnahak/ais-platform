...
function MoreSheet({ open, items, onClose, pathname, user }) {
  ...
  return (
    <div className="fixed inset-0 z-[60] lg:hidden" role="presentation">
      ...
      />
      <div
        className="absolute bottom-0 left-0 right-0 flex max-h-[calc(100dvh-5.5rem-env(safe-area-inset-bottom))] flex-col overflow-hidden rounded-t-2xl border-t border-[var(--color-outline-variant)] bg-[var(--color-surface)] pb-[env(safe-area-inset-bottom)]"
        role="dialog"
        aria-modal="true"
